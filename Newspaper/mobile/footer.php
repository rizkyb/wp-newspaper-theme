    ...
    <div class="td-mobile-footer-wrap">
        <div class="td-container">
            ...
            if(td_util::get_option('tds_footer_social') != 'no') {
				...
				$buffy .= '<p>Contact us: <span class="mycontactstyle"><a href="mailto:thewedding@belladonnagroup.com" target="_top">thewedding@belladonnagroup.com</a></span> </p>';		
				$buffy .= '<p>Jl. DR. Kusuma Atmaja No. 47 Menteng </p>';
				$buffy .= '<p>Jakarta Pusat 10310</p>';
				$buffy .= '<p>JT. 021 - 314 3489</p>';
				$buffy .= '<p>JF. 021 - 391 7414</p>';
				$buffy .= '</div>';
                $buffy .= '</aside></div>';
            }
