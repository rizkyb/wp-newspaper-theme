...
$buffy .= '<div class="' . $td_social_enabled . '"><aside class="footer-text-wrap">';
    $buffy .= '<div class="block-title"><span>' . __td('TENTANG KAMI', TD_THEME_NAME) . '</span></div>';
...
if(td_util::get_option('tds_footer_social') != 'no') {
	$buffy .= '<div class="td-pb-span4"><aside class="footer-social-wrap td-social-style-2">';
		...
		$buffy .= '<div class="mycontactfooter">';
		$buffy .= '<p>Contact us: <span class="mycontactstyle"><a href="mailto:thewedding@belladonnagroup.com" target="_top">info@belladonnagroup.com</a></span> </p>';		
		$buffy .= '<p>Jl. DR. Kusuma Atmaja No. 47 Menteng </p>';
		$buffy .= '<p>Jakarta Pusat 10310</p>';
		$buffy .= '<p>T. 021 - 314 3489</p>';
		$buffy .= '<p>F. 021 - 391 7414</p>';
		$buffy .= '</div>';
	$buffy .= '</aside></div>';
}
