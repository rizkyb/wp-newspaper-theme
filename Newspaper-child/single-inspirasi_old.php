                    ...
                    ?>
                        <div class="td-pb-span8 td-main-content" role="main">
                            <div class="td-ss-main-content">
                                ...
                                if (have_posts()) {
                                    while ( have_posts() ) : the_post();
									 ...
									 echo the_content(); 
										...
										echo do_shortcode ('[wpv-view name="single-inspirasi"]');				
										//echo do_shortcode ('[ess_grid alias="gambar-album"]');
										$dataCredit = get_post_meta( get_the_ID(), 'wpcf-credits');
                                ...
                                ?>
								<hr/>
								<button><a href="http://thewedding.id/galeri-inspirasi">Back to Galeri Inspirasi</a></button>
                                </div>
                                <?php
                                if($td_enable_or_disable_page_comments == 'show_comments') {
